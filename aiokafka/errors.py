...
GroupCoordinatorNotAvailableError = CoordinatorNotAvailableError  # type: ignore
NotCoordinatorForGroupError = NotCoordinatorError  # type: ignore
GroupLoadInProgressError = CoordinatorLoadInProgressError  # type: ignore
...
kafka_errors = {cast(int, x.errno): x for x in _iter_broker_errors()}
