...
def create_ssl_context(
    *,
    cafile: Union[AnyStr, None] = None,
    capath: Union[AnyStr, None] = None,
    cadata: Union[AnyStr, None] = None,
    certfile: Union[AnyStr, None] = None,
    keyfile: Union[AnyStr, None] = None,
    password: Union[AnyStr, None] = None,
    crlfile: None = None
) -> SSLContext:
    """
